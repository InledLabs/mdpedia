---
title: "The DHT"
source: https://libp2p.io/docs/dht/
author: Unknown
excerpt: Distributed Hash Tables provide a decentralized way to store and retrieve data across a network of peers.
---
...
### [Routing Table and K-Buckets](#routing-table-and-k-buckets)
...
### [PUT\_VALUE / GET\_VALUE](#put-value-get-value)
...
### [ADD\_PROVIDER / GET\_PROVIDERS](#add-provider-get-providers)
...
## [Peer Routing vs Content Routing](#peer-routing-vs-content-routing)
...
## [Client vs Server Mode](#client-vs-server-mode)
...
For more details, see the [Security Considerations](https://libp2p.io/docs/security-considerations/) guide.
...
Bucket size (max nodes per bucket)
...
*   [Kademlia DHT guide](https://libp2p.io/docs/kademlia-dht/) — Detailed Kademlia implementation specifics
