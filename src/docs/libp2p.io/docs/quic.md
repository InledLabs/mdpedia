---
title: "QUIC"
source: https://libp2p.io/docs/quic/
author: Unknown
excerpt: QUIC is a new transport protocol that provides an always-encrypted, stream-multiplexed connection built on top of UDP. Learn about QUIC and how it is used in libp2p.
---
...
### [Key challenges with TCP](#key-challenges-with-tcp)
...
### [Comparing HTTP/2 and HTTP/3](#comparing-http-2-and-http-3)
...
### [How does QUIC work?](#how-does-quic-work)
...
### [QUIC native multiplexing](#quic-native-multiplexing)
...
### [Distinguishing multiple QUIC versions in libp2p](#distinguishing-multiple-quic-versions-in-libp2p)
