...
source: https://libp2p.io/docs/transports-overview/
author: Unknown
excerpt: The foundational protocols that move bits around are called transports, and one of libp2p's core requirements is to be transport agnostic. Learn about the transport protocols in libp2p.
---
...
## [Transports and libp2p](#transports-and-libp2p)

To better visualize the types of libp2p connections, check out the [connectivity guide](https://libp2p.io/docs/browser-connectivity/) which outlines the different types of connectivity in libp2p.
