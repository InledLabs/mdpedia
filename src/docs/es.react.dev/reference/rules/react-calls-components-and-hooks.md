...
source: https://es.react.dev/reference/rules/react-calls-components-and-hooks
author: Unknown
...
React must decide when your component function is called [during rendering](https://es.react.dev/reference/rules/components-and-hooks-must-be-pure#how-does-react-run-your-code). In React, you do this using JSX.
...
If a component contains Hooks, it’s easy to violate the [Rules of Hooks](https://es.react.dev/reference/rules/rules-of-hooks) when components are called directly in a loop or conditionally.
...
This way, `<Button />` is much easier to understand and debug. When Hooks are used in dynamic ways, it increases the complexity of your app greatly and inhibits local reasoning, making your team less productive in the long term. It also makes it easier to accidentally break the [Rules of Hooks](https://es.react.dev/reference/rules/rules-of-hooks) that Hooks should not be called conditionally. If you find yourself needing to mock components for tests, it’s better to mock the server instead to respond with canned data. If possible, it’s also usually more effective to test your app with end-to-end tests.
