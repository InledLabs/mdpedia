...
source: https://es.react.dev/reference/react/experimental_taintUniqueValue
author: Unknown
...
This API is only available inside [React Server Components](https://es.react.dev/reference/rsc/use-client).
...
To prevent passing an object containing sensitive data, see [`taintObjectReference`](https://es.react.dev/reference/react/experimental_taintObjectReference).
