...
source: https://es.react.dev/reference/react/experimental_taintObjectReference
author: Unknown
...
Para prevenir el pasar una llave, hash o token, ver [`taintUniqueValue`](https://es.react.dev/reference/react/experimental_taintUniqueValue).
...
### Evita que los datos de usuario lleguen al cliente de manera no intencionada[](#prevent-user-data-from-unintentionally-reaching-the-client "Link for Evita que los datos de usuario lleguen al cliente de manera no intencionada ")
...
#### Protegiendo contra fugas en la obtención de datos.[](#protecting-against-leaks-in-data-fetching "Link for Protegiendo contra fugas en la obtención de datos. ")
