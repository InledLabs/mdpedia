---
title: <title> – React
source: https://es.react.dev/reference/react-dom/components/title
author: Unknown
...
`<title>` supports all [common element props.](https://es.react.dev/reference/react-dom/components/common#props)
