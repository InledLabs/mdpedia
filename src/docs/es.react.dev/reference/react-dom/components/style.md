---
title: <style> – React
source: https://es.react.dev/reference/react-dom/components/style
author: Unknown
...
`<style>` supports all [common element props.](https://es.react.dev/reference/react-dom/components/common#props)
...
React can move `<style>` components to the document’s `<head>`, de-duplicate identical stylesheets, and [suspend](https://es.react.dev/reference/react/Suspense) while the stylesheet is loading.
