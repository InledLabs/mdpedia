---
title: Componentes de React DOM – React
source: https://es.react.dev/reference/react-dom/components
author: Unknown
...
# Componentes de React DOM – React
...
## Componentes comunes[](#common-components "Link for Componentes comunes ")

Todos los componentes integrados en el navegador admiten algunas props y eventos.

*   [Componentes comunes (ej. `<div>`)](https://es.react.dev/reference/react-dom/components/common)

Esto incluye props específicos de React como `ref` y `dangerouslySetInnerHTML`.

* * *

## Componentes de formulario[](#form-components "Link for Componentes de formulario ")
...
Son especiales en React porque pasando el prop `value` los hace _[controlados.](https://es.react.dev/reference/react-dom/components/input#controlling-an-input-with-a-state-variable)_

* * *

## Componentes de Recursos y Metadatos[](#resource-and-metadata-components "Link for Componentes de Recursos y Metadatos ")
...
*   [`<meta>`](https://es.react.dev/reference/react-dom/components/meta)
*   [`<script>`](https://es.react.dev/reference/react-dom/components/script)
*   [`<style>`](https://es.react.dev/reference/react-dom/components/style)
*   [`<title>`](https://es.react.dev/reference/react-dom/components/title)
...
## Todos los componentes HTML[](#all-html-components "Link for Todos los componentes HTML ")
...
### Elementos HTML personalizados[](#custom-html-elements "Link for Elementos HTML personalizados ")
...
## Todos los componentes SVG[](#all-svg-components "Link for Todos los componentes SVG ")
