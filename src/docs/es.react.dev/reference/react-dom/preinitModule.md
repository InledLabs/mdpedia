...
source: https://es.react.dev/reference/react-dom/preinitModule
author: Unknown
...
Si deseas que el navegador descargue el módulo pero no lo ejecute de inmediato, usa [`preloadModule`](https://es.react.dev/reference/react-dom/preloadModule) en su lugar. Si deseas preinicializar un script que no es un módulo ESM, usa [`preinit`](https://es.react.dev/reference/react-dom/preinit).
