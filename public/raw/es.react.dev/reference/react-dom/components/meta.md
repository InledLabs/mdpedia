---
title: <meta> – React
source: https://es.react.dev/reference/react-dom/components/meta
author: Unknown
...
`<meta>` supports all [common element props.](https://es.react.dev/reference/react-dom/components/common#props)
