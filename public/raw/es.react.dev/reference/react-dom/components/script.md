---
title: <script> – React
source: https://es.react.dev/reference/react-dom/components/script
author: Unknown
...
`<script>` supports all [common element props.](https://es.react.dev/reference/react-dom/components/common#props)
