...
source: https://es.react.dev/reference/react/captureOwnerStack
author: Unknown
...
*   React error handlers ([React Root options](https://es.react.dev/reference/react-dom/client/createRoot#parameters) `onCaughtError`, `onRecoverableError`, and `onUncaughtError`)
...
The Owner Stack is different from the Component Stack available in React error handlers like [`errorInfo.componentStack` in `onUncaughtError`](https://es.react.dev/reference/react-dom/client/hydrateRoot#show-a-dialog-for-uncaught-errors).
