...
author: Unknown
excerpt: Learn how to run libp2p interoperability and performance tests locally, including installation, filtering, snapshots, and local patching.
---
...
### [Linux (Debian 13)](#linux-debian-13)
...
## [Understanding the Filtering System](#understanding-the-filtering-system)

The unified-testing framework uses a powerful two-stage filtering model that lets you precisely control which tests run.

### [Filter Syntax: Pipe-Separated Substring Matching](#filter-syntax-pipe-separated-substring-matching)
...
### [Two-Stage Model: SELECT then IGNORE](#two-stage-model-select-then-ignore)
...
### [Listing Without Running](#listing-without-running)
...
### [Reproducing from Snapshot](#reproducing-from-snapshot)
...
## [Local Patching Strategy](#local-patching-strategy)
...
### [Step 2: Clone the Implementation Repository](#step-2-clone-the-implementation-repository)
...
### [Step 4: Create the Patch File](#step-4-create-the-patch-file)
...
### [Step 5: Update images.yaml](#step-5-update-images-yaml)
...
### [Start Small, Listing First](#start-small-listing-first)
...
### [Clean Up Periodically](#clean-up-periodically)
...
### ["bash: associative array: bad array subscript"](#bash-associative-array-bad-array-subscript)
...
### [yq Command Not Found](#yq-command-not-found)
...
*   [Write a Performance Test Application](https://libp2p.io/docs/write-a-perf-test-app/)
*   [Write a Transport Test Application](https://libp2p.io/docs/write-a-transport-test-app/)
*   [Write a Hole-Punch Test Application](https://libp2p.io/docs/write-a-hole-punch-test-app/)
