---
title: "mDNS"
source: https://libp2p.io/docs/mdns/
author: Unknown
excerpt: mDNS uses a multicast system of DNS records over a local network to enable peer discovery.
---
...
mDNS, or multicast Domain Name System, is a way for nodes to use IP multicast to publish and receive DNS records [RFC 6762](https://www.rfc-editor.org/rfc/rfc6762) within a local network. Nodes broadcast topics they're interested in. mDNS is commonly used on home networks to allow devices such as computers, printers, and smart TVs to discover each other and connect.

## [mDNS in libp2p](#mdns-in-libp2p)
