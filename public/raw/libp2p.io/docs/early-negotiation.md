...
source: https://libp2p.io/docs/early-negotiation/
author: Unknown
excerpt: Early stream multiplexer negotiation is an optimization in libp2p where peers can negotiate which multiplexer to use during the security protocol handshake, saving one round trip.
---
...
## [Vanilla stream multiplexer selection process](#vanilla-stream-multiplexer-selection-process)
...
First, the security protocol is negotiated, then this protocol is used to perform a cryptographic handshake. libp2p currently supports [Noise](https://libp2p.io/docs/noise/) and [TLS 1.3](https://libp2p.io/docs/tls/). Once the cryptographic handshake completes, multistream-select runs again on top of the secured connection to negotiate a steam multiplexer, like [yamux](https://libp2p.io/docs/yamux/) or [mplex](https://libp2p.io/docs/mplex/).
...
### [ALPN extension in TLS](#alpn-extension-in-tls)
...
### [Extension registry in Noise](#extension-registry-in-noise)
...
> The extension registry is modeled after [RFC 6066](https://www.rfc-editor.org/rfc/rfc6066) (for TLS) and [RFC 9000](https://datatracker.ietf.org/doc/html/rfc9000#section-19.21) (for QUIC).

More information is available in the [Noise specification](https://github.com/libp2p/specs/blob/master/noise/README.md#libp2p-data-in-handshake-messages).

🛈

See the inclined muxer negotiation \[specification\](https://github.com/libp2p/specs/blob/master/connections/inlined-muxer-negotiation.md) for more details.
