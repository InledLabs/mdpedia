...
source: https://libp2p.io/docs/standalone-connectivity/
author: Unknown
excerpt: Learn about transport protocols for standalone libp2p nodes including TCP, QUIC, and hole punching for NAT traversal.
---
...
### [TCP Implementation Status](#tcp-implementation-status)
...
### [QUIC Implementation Status](#quic-implementation-status)
...
### [Obtaining a Direct Connection](#obtaining-a-direct-connection)
...
### [Hole Punching Implementation Status](#hole-punching-implementation-status)
