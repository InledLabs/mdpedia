...
source: https://libp2p.io/docs/listen-and-dial/
author: Unknown
excerpt: Transports are defined in terms of two core operations, listening and dialing. Learn about how peers use both interfaces in libp2p.
---
...
## [Common transport interfaces](#common-transport-interfaces)
...
The [addressing doc](https://libp2p.io/docs/addressing/) goes into more detail, but an overview of how multiaddresses work is helpful for understanding the dial and listen interfaces.
...
For more complex examples, see [addressing](https://libp2p.io/docs/addressing/).
...
When dialing a remote peer, the multiaddress should include the [PeerId](https://libp2p.io/docs/peers/#peer-id) of the peer you're trying to reach. This lets libp2p establish a secure communication channel and prevents impersonation.
...
The `/p2p/QmcEPrat8ShnCph8WjkREzt5CPXF2RwhYxYBALDcLC1iV6` component uniquely identifies the remote peer using the hash of its public key. For more, see the [peer identity content](https://libp2p.io/docs/peers/#peer-id).
...
## [Supporting multiple transports](#supporting-multiple-transports)
...
The libp2p component responsible for managing the transports is called the switch, which also coordinates [protocol negotiation](https://libp2p.io/docs/protocols/#protocol-negotiation), stream multiplexing, establishing secure communication and other forms of "connection upgrading".
